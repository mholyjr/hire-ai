  ...
  const features = [
    {
      ...
      description:
        "AI analyzes resumes and experience to score candidates objectively.",
    },
    {
      name: "Skill Matching",
      description:
        "Automatically map candidate skills to your job requirements.",
    },
    {
      name: "Data-Driven Insights",
      description:
        "Get detailed reports and rankings to make informed hiring decisions.",
    },
  ];
  ...
  return (
    <div className="px-3">
      ...
      >
        ...
        >
          Use World-class AI <br /> for your hiring
        </h2>
        <canvas
