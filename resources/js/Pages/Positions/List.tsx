...
import { EmptyPositions } from "./Partials/EmptyPositions";
import { TeamStatsCharts } from "./Partials/TeamStatsCharts";
...
export default function List({ positions, teamStats }: PositionsProps) {
