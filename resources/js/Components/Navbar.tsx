...
export const Navbar = ({ sidebar }: { sidebar: boolean }) => {
      ...
      <div className=" px-6">
        <div className="flex justify-between h-16">
          <div className="flex">
            ...
            {/* <!-- Navigation Links --> */}
            <div
              className={`hidden space-x-8 sm:-my-px ${!sidebar ? "sm:ml-10" : ""} sm:flex`}
            >
              <NavLink
              ...
              <NavLink
                href={route("candidates.list")}
                active={
                  route().current("candidates.list") ||
              ...
              <NavLink
                href={route("billing")}
                active={
                  route().current("billing") || route().current("billing.index")
                }
              >
                Billing
              </NavLink>
